    ...
    return (
        <>
            <div className='flex justify-end'>
                <Link href="/admin/brand/add-brand">
                    <button className='bg-primary text-white px-4 py-2 rounded-lg'>
                        Tambah Brand
                    </button>
                </Link>
            </div>
            <CardWithTitle className='my-5 lg:col-span-4 col-span-12' title="List Brand">
                <div className="overflow-x-auto">
                    <Table>
                        <Table.Head>
                            <th className='text-start pl-6 text-secondary'>No</th>
                            <th className='text-start pl-6 text-secondary'>Nama</th>
                            <th className='text-start pl-6 text-secondary'>Status Brand</th>
